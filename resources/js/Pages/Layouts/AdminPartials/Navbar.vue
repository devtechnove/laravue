<template>
  <div class="navbar-header green darken-4">
        <div class="d-flex">
            ...
            <!-- LOGO -->
            <div class="navbar-brand-box green darken-4">
                <a href="/admin" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="assets/images/logo/logo-bandes-mini.png" alt="" height="26">
                    </span>
                    <span class="logo-lg">
                        <img src="assets/images/logo/logo-bandes.png" alt="" height="28">
                    </span>
                </a>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                   ...
                   <!--  <a class="dropdown-item" href="#"><i
                    ...
                    <div class="dropdown-divider"></div>
                     <a class="dropdown-item text-primary" href="#" @click.prevent="logOut"><i
                        class="mdi mdi-power font-size-16 align-middle me-2 text-primary" ></i>
                    <span>Salir del sistema</span></a>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            logOut() {
                this.auth.logOut();
                this.$router.push("/");
                this.$store.dispatch("alert", { message: "Has cerrado sesión satisfactoriamente"})
            }
        }
    }
</script>
